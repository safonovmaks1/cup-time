	...
	<footer className="footer">
		<div className="container footer__container">
			<a className="footer__logo-link" href="/">
				<img className="footer__logo" src="image/logo.svg" alt="Logo Cup Time" />
			</a>
			...
			<div className="footer__info">
				...
				<ul className="footer__developers developer-list">
					<li className="developer-list__item">
						Designer:
						<a className="developer-list__link" target="_blank" href="https://t.me/Mrshmallowww">
							Anastasia Ilina
						</a>
					</li>
					<li className="developer-list__item">
						Developer:
						<a className="developer-list__link" target="_blank" href="https://t.me/MaksSafonov">
							Maksim Safonov
						</a>
					</li>
				</ul>
